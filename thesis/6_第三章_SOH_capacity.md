...
进一步地，LSTM网络会将 $C_{t-1}$、$H_{t-1}$ 和 $X_{t}$ 一起作为模型输入，如【图3-2】(c)，对于输入 $H_{t-1}$，与 $X_{t}$ 类似，也要进行线性变换，参与门控信号的生成，这样，【式3-9】至【式3-11】修正为【式3-14】至【式3-16】
